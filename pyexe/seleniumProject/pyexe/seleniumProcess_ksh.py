...
msg=EmailMessage()
# 제목 입력
msg['Subject']="중간시험_김승현"
# 내용 입력
msg.set_content("셀레니움_자동화_4기_김승현")
# 보내는 사람
msg['From'] = 'seunghyun7272@gmail.com'
# 받는 사람
msg['To'] = 'seunghyun7272@gmail.com'

# 첨부파일 #1 추가
file = "selenium_KSH.csv"
